...
?>
<p>
This site provides example usage of the conventions regarding the errorURL SAML metadata attribute defined by the <a href="https://refeds.org/specifications/errorurl-v1">SAML V2.0 Metadata Deployment Profile for errorURL Version 1.0</a>. The errors defined in the profile are simulated and the placeholders are replaced in the IdPs errorURL to simulate the use cases of the profile. Unless federated login is performed, an example errorURL from a dummy IdP is used.
<p>
